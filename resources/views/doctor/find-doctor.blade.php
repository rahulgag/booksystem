									...
									<div class="doctor-widget">
										<div class="doc-info-left">
											...
											<div class="doc-info-cont">
												<h4 class="doc-name"><a href="doctor-profile.html">{{$item->name}}</a></h4>
												<input type="hidden" value="{{$item->id}}" class="docde" name="docde">
										...
										<div class="doc-info-right">
											...
											<div class="clinic-booking">
												<a class="apt-btn" id="bookapp">Book Appointment</a>
											</div>
										</div>
									</div>
								</div>
...
<script>
    ...
    //     // }
    // });
		$(document).on("click", "#bookapp", function(e) {
			e.preventDefault();
			var did = $(this).closest('.doctor-widget').find('.docde').val();
				url = "{{ url('bookdetail') }}?did=" + did;
